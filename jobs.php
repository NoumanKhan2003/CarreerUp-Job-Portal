            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '      <p class="card-text">Location: ' . $row["location"] . '</small></p>';
                        echo '      <p class="card-text">Job Type: ' . $row["job_type"] . '</small></p>';
                        echo '      <p class="card-text">Salary: ' . $row["salary"] . '</small></p>';
