...
<header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <h1 class="top">Events to Enhance your Skills</h1>
    </header>
    <main>
    <div class="container">
        <div class="row">
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '      <p class="card-text">Company: '.$row["company_name"].'</small></p>';
                    echo '      <p class="card-text">Date: '.$row["date"].'</small></p>';
                    echo '      <p class="card-text">Last Date to Apply: '.$row["lastDate"].'</small></p>';
                    echo '      <p class="card-text">Event Type: '.$row["event_type"].'</small></p>';
                    echo '      <p class="card-text">Prizes: '.$row["prizes"].'</small></p>';
