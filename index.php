            ...
            <div class="carousel-inner">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '      <a href="jobDetails.php?job_id=' . $row["id"] . '" class="btn btn-primary">View Details</a>';
                        echo '    </div>';
                        echo '  </div>';
                        echo '</div>';
                    }
                    ...
                    <div class="row">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '      <a href="eventDetails.php?event_id=' . $row["id"] . '" class="btn btn-primary">View Details</a>';
                                echo '    </div>';
                                echo '  </div>';
                                echo '</div>';
                            }
